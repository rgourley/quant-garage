#!/usr/bin/env python3
"""
CLI wrapper for the options-flow skill.
...
from quant_garage.skills.options_flow import run, render, DEFAULT_WATCHLIST


def main() -> int:
    ap = argparse.ArgumentParser(
        prog="run-options-flow",
        description="Cheddar Flow / FlowAlgo-style unusual options activity scanner.",
    )
    ap.add_argument("tickers", nargs="*", help=f"Watchlist. Default: {DEFAULT_WATCHLIST}")

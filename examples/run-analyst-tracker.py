#!/usr/bin/env python3
"""CLI wrapper for analyst-tracker.
...
def main() -> int:
    ap = argparse.ArgumentParser(
        prog="run-analyst-tracker",
        description="Track sell-side analyst ratings, upgrades, downgrades, and price target changes.",
    )

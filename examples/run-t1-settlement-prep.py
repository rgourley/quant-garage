#!/usr/bin/env python3
"""
CLI wrapper for the t+1-settlement-prep skill.
...
def main() -> int:
    ap = argparse.ArgumentParser(
        prog="run-t1-settlement-prep",
        description="T+1 settlement risk exception report from a trades CSV.",
    )
    ap.add_argument("csv_path", help="Path to trades CSV.")
